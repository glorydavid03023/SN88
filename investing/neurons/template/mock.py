...
_MetagraphBase = getattr(bt, "metagraph", None) or getattr(bt, "Metagraph")


class MockMetagraph(_MetagraphBase):
...
_DendriteBase = getattr(bt, "dendrite", None) or getattr(bt, "Dendrite")


class MockDendrite(_DendriteBase):
    """
        ...
        async def query_all_axons(streaming: bool):
            ...
            async def single_axon_response(i, axon):
                ...
                if process_time < timeout:
                    ...
                    s.strategy_output = s.strategy_input * 2
